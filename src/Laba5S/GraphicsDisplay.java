...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        this.axisFont = new Font("Serif", Font.PLAIN, 16);
        this.labelsFont = new Font("Serif", Font.PLAIN, 10);
    ...
    public void zoomToRegion(double x1, double y1, double x2, double y2) {  //увеличение
    ...
    protected java.awt.geom.Point2D.Double translateXYtoPoint(double x, double y) {     //перемещаем график
